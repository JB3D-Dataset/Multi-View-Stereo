...
[Dataset link](https://zenodo.org/records/22787920) | [Paper](https://www.sciencedirect.com/science/article/pii/S2667393226000359) | [Project page](https://jb3d-dataset.github.io/Multi-View-Stereo/) 
...
- [X] Paper release
- [X] Dataset release with download and file-format documentation
- [ ] Novel view synthesis and 3D Gaussian Splatting (3DGS) benchmark
- [ ] Semantic segmentation of LiDAR point clouds

## Dataset Access

The approximately 90 GB dataset will be hosted outside GitHub and offered as direct download. This repository contains only evaluation code, documentation and result tables.
...
@unpublished{Hermann_JB3D,
	...
	year = {2026},
	issn = {2667-3932},
	doi = {https://doi.org/10.1016/j.ophoto.2026.100149},
	url = {https://www.sciencedirect.com/science/article/pii/S2667393226000359},
}
```